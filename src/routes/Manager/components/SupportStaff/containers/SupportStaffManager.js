import SupportStaffManager from '../components/SupportStaffManager/index';
...
const enhance = compose(
    ...
    withProps(props => {
        return {modalTitle: 'Invite a Support Staff to Fitango Demo'}
    }),
    withModal
);

export default enhance(SupportStaffManager);